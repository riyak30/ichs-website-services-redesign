const servicesData = [
  ...
  },
  {
    ...
    name: 'Dental Care',
    category: 'general',
    description: 'Full dental care for the whole family includes check-ups, cleanings, restoration and dental care.',
    funFact: {
    ...
    subServices: [
      { name: 'Preventive Care', description: 'Exams, cleanings, X-rays, and fluoride treatments for all ages.' },
      { name: 'Restorative Care', description: 'Fillings, crowns, bridges, and dentures to restore your smile.' },
      { name: 'Oral Surgery', description: 'Tooth extractions and surgical procedures performed on-site.' },
      { name: 'Pediatric Dentistry', description: 'Child-friendly dental care from the very first tooth.' },
      { name: 'Urgent Dental Care', description: 'Same-day or next-day appointments for dental pain and emergencies.' },
    ],
  },
  {
