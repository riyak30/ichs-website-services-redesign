          ...
          {SLIDES.map((s, i) => (
            ...
            >
              ...
              <div className={`hero-slide-right${s.rightClass ? ' ' + s.rightClass : ''}`}>
                {s.announce ? (
                  <div className="announce-graphic">
                    <svg viewBox="0 0 24 24" style={{ width: 72, height: 72, stroke: 'rgba(255,255,255,0.25)', fill: 'none', strokeWidth: 1 }}>
                      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                    </svg>
                    <div className="announce-date-chip">Behavioral Health · Bellevue</div>
                  </div>
                ) : (
